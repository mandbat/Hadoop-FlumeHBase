...
/**
 * A simple serializer to be used with the AsyncHBaseSink that returns puts from
 * an event, by writing the event body into it. The headers are discarded. It
 * also updates a row in hbase which acts as an event counter.
 *
 ...
 */
public class SimpleSerializer implements AsyncHbaseEventSerializer {
	private byte[] table;
	private byte[] cf;
	...
	public List<AtomicIncrementRequest> getIncrements() {
		...
		MyConsoleWriter.write("Atomic - incrementRow	: " + incrementRow);
		MyConsoleWriter.write("Atomic - incrementColumn		: " + incrementColumn);
	...
	public void configure(Context context) {
		...
		MyConsoleWriter.write("incrementRow		: " + incrementRow, "//111//start.txt");
		MyConsoleWriter.write("incrementColumn	: " + incrementColumn, "//111//start.txt");
